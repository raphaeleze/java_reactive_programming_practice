...
class RestMapperTest {
  ...
  void givenDbUserRecipe_whenMapToRestDto_thenReturnRestUserRecipe() {
    ...
    // THEN
    assertThat(result.getRecipeId()).isEqualTo(UUID.fromString(dbUserRecipe1().getRecipeId()));
    assertThat(result.getUserId()).isEqualTo(UUID.fromString(dbUserRecipe1().getUserId()));
  ...
  void givenDbUserRecipeWithNullFields_whenMapToRestDto_thenIgnoreNullFields() {
    ...
    // THEN
    assertThat(result.getRecipeId()).isEqualTo(UUID.fromString(dbUserRecipe.getRecipeId()));
    assertThat(result.getUserId()).isEqualTo(UUID.fromString(dbUserRecipe.getUserId()));
  ...
  private DbRecipeXUser getDbRecipeXUser() {
